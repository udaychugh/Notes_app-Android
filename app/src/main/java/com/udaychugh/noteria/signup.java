...
public class signup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        msignup.setOnClickListener((new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(getApplicationContext(), "password must contains atleast 7 characters", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    // register here for firebase
    ...
    private void sendEmailVerification()
    {
        ...
        {
            Toast.makeText(getApplicationContext(),"Unable to verify try again",Toast.LENGTH_SHORT).show();
        }
    }
}